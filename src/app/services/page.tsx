                    ...
                    >
                      ...
                      {isPromo ? (
                        <span style={{ display: 'flex', alignItems: 'center', gap: '6px', flexShrink: 0 }}>
                          ...
                          <span style={{ color: '#DC2626', fontWeight: 700, fontSize: '15px' }}>{item.is_from_price ? 'à partir de ' : ''}{item.price}{item.price_max ? ` / ${item.price_max}` : ''}DH</span>
                        </span>
                      ) : (
                        <span className={styles.itemPrice}>
                          {item.is_from_price ? <span style={{ fontSize: '12px', fontStyle: 'italic', opacity: 0.7 }}>à partir de </span> : null}{item.price}{item.price_max ? ` / ${item.price_max}` : ''}DH
                        </span>
                      )}
                    </motion.div>
                  )
